...
void read_params(Number_t &en, Number_t &in, std::string &network_type,
                 ...
                 Number_t &nr_pops, Number_t &sn, Number_t &extI_type,
                 Current_t &Imin, Current_t &Imax, Number_t &nr_steps,
                 Rate_t &fS, Rate_t &fR, Rate_t &SE,
                 Rate_t &SI)
{
    ...
    while ( std::getline(input_file, line) )
    {
        ...
        else
        {
            ...
            else if ( var_name == "extI_type" )
            {
                std::cout << "Variable 'extI_type'\tis found. Its value is ";
                std::cout << var_value_str << std::endl;
                extI_type = std::stoi(var_value_str);
                std::cout << "\t\tAssigned: extI_type=" << extI_type << std::endl;
            }
            else if ( var_name == "Imin" )
            {
                std::cout << "Variable 'Imin'\tis found. Its value is ";
                std::cout << var_value_str << std::endl;
                Imin = std::stod(var_value_str);
                std::cout << "\t\tAssigned: Imin=" << Imin << std::endl;
            }
            else if ( var_name == "Imax" )
            {
                std::cout << "Variable 'Imax'\tis found. Its value is ";
                std::cout << var_value_str << std::endl;
                Imax = std::stod(var_value_str);
                std::cout << "\t\tAssigned: Imax=" << Imax << std::endl;
            }
            else if ( var_name == "nr_steps" )
            {
                std::cout << "Variable 'nr_steps'\tis found. Its value is ";
                std::cout << var_value_str << std::endl;
                nr_steps = std::stoi(var_value_str);
                std::cout << "\t\tAssigned: nr_steps=" << nr_steps << std::endl;
            }
            else if ( var_name == "fS" )
            {
